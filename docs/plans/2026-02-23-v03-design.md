...
src/signalops/scoring/       # New package (T3)
    ...
    engine.py                # Plugin orchestrator
    rules.py                 # Config-driven rules engine
...
CREATE TABLE model_registry (
    ...
    provider    VARCHAR(32) NOT NULL,       -- "openai", "anthropic", "local"
    endpoint    VARCHAR(512),               -- Fine-tuned model endpoint
...
coordinate by having T2 merge first, T3 rebases.
